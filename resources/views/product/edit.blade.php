    ...
    <div class="section-empty section-item text-center">
        <div class="container content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{ route('product.edit') }}" class="form-box form-ajax" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="title" name="title" placeholder="Item Name..." type="text"
                                    class="form-control form-value required" value="{{$product->title}}" required>
                            </div>
                            <hr class="space s" />
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="description" name="description" placeholder="Brief Description about product..."
                                    class="form-control form-value" value=""  required>{{$product->description}}</textarea>
                                <hr class="space s" />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="amount" value="{{$product->amount}}" name="amount" placeholder="Price per unit ..." type="number"
                                            class="form-control form-value" required>
                                    </div>
                                    <hr class="space s" />
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="description" name="order_note" placeholder="Brief Description about product..."
                                        class="form-control form-value" >{{$product->order_note}}</textarea>
                                    <hr class="space s" />
                                </div>
                                <hr class="space s" />
                                <label>Upload images</label><span style="color:#ff0000">*</span>
                                <input id="fileupload" accept="image/*" name ='images[]' type="file" multiple="multiple" />
                                <hr />
                                <b>Live Preview</b>
                                <br />
                                <br />
                            ...
                            <div col-md-3>
                                ...
                                <button class="btn-sm btn" type="submit">Update Item</button>
                            </div>
                        </div>
