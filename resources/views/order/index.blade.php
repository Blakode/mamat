            ...
            <table class="table table-condensed table-hover table-striped bootgrid-table" aria-busy="false">
                <thead>
                    <tr>
                        ...
                        <th data-column-id="logo" class="text-left" style="">
                            <a href="javascript:void(0);" class="column-header-anchor sortable">
                        ...
                        <th data-column-id="more-info" class="text-left" style="">
                            <a href="javascript:void(0);" class="column-header-anchor sortable">
                        ...
                        <th data-column-id="link" class="text-left" style="">
                            <a href="javascript:void(0);" class="column-header-anchor sortable">
                        ...
                        <th data-column-id="link-icon" class="text-left" style="">
                            <a href="javascript:void(0);" class="column-header-anchor sortable">
                    ...
                    @foreach ($orders as $order)
                        <tr data-row-id="{{ $order->id }}">
                            ...
                            <td class="text-left" style="">
                                <a class="lightbox" href="{{ asset('assets/images/gallery/square-1.jpg') }}">
                                    <img src="{{ asset('assets/images/gallery/square-1.jpg') }}">
                                </a>
                            </td>
                            <td class="text-left" style="">
                                <a href="https://it.wikipedia.org/wiki/Walter_White" class="btn btn-default btn-xs">Read
                                    more
                                </a>
                            </td>
                            <td class="text-left" style="">
                                <a href="https://it.wikipedia.org/wiki/Walter_White" class="link">{{ $order->status }}
                                </a>
                            </td>
                            <td class="text-left" style="">
                                <a target="_blank" href="https://it.wikipedia.org/wiki/Walter_White" class="link">
                                    <i class="fa fa-external-link">00:00</i>
                                </a>
                            </td>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="pagination">
                            ...
                            <li class="prev disabled" aria-disabled="true"><a href="#prev" class="button">&lt;</a></li>
                            <li class="page-1 active" aria-disabled="false" aria-selected="true"><a href="#1"
                                    class="button">1</a></li>
                            <li class="next disabled" aria-disabled="true"><a href="#next" class="button">&gt;</a></li>
