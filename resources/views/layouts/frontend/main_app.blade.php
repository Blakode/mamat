        <!-- header starts    -->
                ...
                <link rel="stylesheet" href="{{asset('assets/scripts/jquery.bootgrid.css')}}">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 footer-center text-left">
                            <p>e-mail <b> info@mamatindomiespot.com</b></p>
                            <p>phone <b> (+234)  812 2945286</b></p>
                            <p><b></b></p>
                        ...
                        <div class="col-md-4 footer-right text-left">
                            ...
                            <hr class="space s" />
                            <p>
                                Sign up for Mama T monthly newsletter and get to know more about our latest adventures and much mores...
                            </p>
                            <hr class="space s" />
                            <form action="" class="form-box form-ajax" method="post" data-email="federico@pixor.it">
                                <div class="input-group">
                                    <input type="email" class="form-control form-value" placeholder="email@ ...com">
                        ...
                        <script async src="{{asset('assets/scripts/custom_scripts.js')}}"></script>
                        <script src="{{asset('assets/scripts/imagesloaded.min.js')}}"></script>
                        <script src='{{asset('assets/scripts/isotope.min.js')}}'></script>
                        <script src='{{asset('assets/scripts/jquery.twbsPagination.min.js')}}'></script>
                        <script src='{{asset('assets/scripts/flexslider/jquery.flexslider-min.js')}}'></script>
                        <script src='{{asset('assets/scripts/jquery.tab-accordion.js')}}'></script>
                        <script src='{{asset('assets/scripts/parallax.min.js')}}'></script>
                        <script src='{{asset('assets/scripts/smooth.scroll.min.js')}}'></script>
                        {{-- <script src="https://themekit.dev/tools/sidebar/sidebar.js" data-setting="gourmet"></script> --}}
        </footer>
            <!-- End Footer section -->
